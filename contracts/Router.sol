...
contract Router is Initializer {
    ...
    constructor(address _erc1538Delegate, address _pixelFactoryDeployed, address _colorDeployed) public payable {
        ...
        _initializer(_pixelFactoryDeployed, _colorDeployed);
    }
